...
<div class="auth-wrap my-8">
    <div class="auth-card">
        <div class="auth-head">
            ...
            <div class="auth-title"><?php echo clean(get_setting('school_name', 'سامانه مدیریت کارنامه‌های تحصیلی')); ?></div>
            <div class="auth-sub">جهت ورود یا استعلام کارنامه، اطلاعات هویتی خود را وارد نمایید</div>
        </div>
