...
<div class="timer-fixed" id="timerDisplay">⏱ <?php echo gmdate('H:i:s', $remaining); ?></div>
...
<div class="max-w-5xl mx-auto space-y-4 anti-copy" id="examContainer">
    ...
    <div id="examStage" class="hidden space-y-4">
        <div class="card bg-blue-50 border-blue-200">
            ...
            <div class="flex gap-3 text-xs mt-1"><span>مدت: <?php echo tr_num($exam['duration_minutes'],'fa'); ?> دقیقه</span><span>سوالات: <?php echo tr_num(count($questions),'fa'); ?></span><span>نمره کل: <?php echo tr_num($maxScore,'fa'); ?></span></div>
        </div>
...
function startTimer(){
    ...
    function updateTimerDisplay(){
        ...
        document.getElementById('timerDisplay').textContent = '⏱ '+String(h).padStart(2,'0')+':'+String(m).padStart(2,'0')+':'+String(s).padStart(2,'0') + (remainingSeconds<300 ? ' ⚠️' : '');
