...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'execute_students') {
    ...
    log_activity($_SESSION['admin_id'] ?? null, 'ایمپورت و آپدیت دانش‌آموزان جامع', "تعداد $updatedCount بروزرسانی و $insertedCount جدید با پرونده کامل ثبت شد.$classInfo");
    set_flash_message('success', "✅ عملیات با پرونده کامل انجام شد: $updatedCount دانش‌آموز بروزرسانی و $insertedCount دانش‌آموز جدید با تمام فیلدهای جدید (کد پستی، آدرس، بیماری، شغل والدین، محل تولد...) ثبت شد.$classInfo");
