...
<div class="space-y-6">
    ...
    <div class="card flex gap-4 items-center">
        <div class="avatar-lg" style="width:90px;height:110px;border-radius:.75rem"><?php if(!empty($student['photo_url'])): ?><img src="<?php echo clean($student['photo_url']); ?>"><?php else: ?>👤<?php endif; ?></div>
    ...
    <div class="grid grid-cols-2 gap-6">
        <div class="card space-y-3">
            ...
            <p><b>نام پدر:</b> <?php echo clean($student['father_name'] ?: '---'); ?></p>
            <p><b>تاریخ تولد:</b> <?php echo tr_num($student['birth_date'] ?: '---', 'fa'); ?></p>
            <p><b>پایه:</b> <?php echo clean($student['grade_level']); ?></p>
            <p><b>کلاس:</b> <?php echo clean($student['class_name']); ?></p>
        </div>
        <div class="card space-y-3">
            <h3 class="font-bold text-primary border-b pb-2">اطلاعات تماس و وضعیت</h3>
            <p><b>موبایل دانش‌آموز:</b> <?php echo tr_num($student['phone'] ?: '---', 'fa'); ?></p>
