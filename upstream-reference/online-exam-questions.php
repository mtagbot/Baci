...
<div class="space-y-6 max-w-6xl mx-auto">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
            ...
            <a href="online-exam-preview.php?exam_id=<?php echo $examId; ?>" target="_blank" class="btn btn-primary text-xs">👁️ پیش‌نمایش دانش‌آموز</a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 gap-6">
                        ...
                        <div class="question-card" data-id="<?php echo $q['id']; ?>">
                            ...
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex gap-1">
                                    <a href="?exam_id=<?php echo $examId; ?>&edit=<?php echo $q['id']; ?>" class="btn btn-secondary text-xs">✏️ ویرایش</a>
                                    <form method="POST" onsubmit="return confirm('حذف سوال؟')" class="inline"><input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>"><input type="hidden" name="question_id" value="<?php echo $q['id']; ?>"><button name="delete_question" class="btn btn-danger text-xs">🗑️</button></form>
                                </div>
                            </div>
        ...
        <div class="space-y-4" id="addQuestionForm">
            <div class="card border-2 border-indigo-100">
                <h3 class="font-bold mb-3"><?php echo $editQuestion?'✏️ ویرایش سوال #'.tr_num($editQuestion['id'],'fa'):'➕ افزودن سوال جدید حرفه‌ای'; ?></h3>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <div class="q-editor-toolbar" id="qToolbar">
                                ...
                                <button type="button" onclick="insertQImage()">🖼️ تصویر</button>
