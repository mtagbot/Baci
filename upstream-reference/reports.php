    ...
    <form method="POST" action="reports.php?id=<?php echo $reportId; ?>" id="reportForm">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6" style="display:none;">
            ...
            <div>
                ...
                <input type="text" name="term_old" class="form-input" value="<?php echo clean($repData['term'] ?? 'نوبت اول'); ?>">
            </div>
            <div>
                <label class="block text-xs font-semibold mb-1">ماه کارنامه</label>
                <input type="text" name="report_month_old" class="form-input" value="<?php echo clean($repData['report_month'] ?? 'دی'); ?>">
            </div>
        </div>
