...
if (!function_exists('generate_report_card_image')) {
    function generate_report_card_image($reportId) {
        ...
        $photoX=82; $photoY=210; imagefilledrectangle($im,$photoX,$photoY,$photoX+120,$photoY+150,$soft); imagerectangle($im,$photoX,$photoY,$photoX+120,$photoY+150,$primary); if(!report_image_place_photo($im,$r['photo_url']??'',$photoX+2,$photoY+2,116,146)) gd_text($im,'عکس',$photoX+60,$photoY+82,15,$muted,false,'center');
