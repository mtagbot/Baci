...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .ranks-box { font-size: 10px !important; padding: 3px !important; margin-bottom: 4px !important; }
        ...
        .photo-box { width: 55px; height: 70px; border: 1px solid #000; display: flex; align-items: center; justify-content: center; overflow: hidden; }
        ...
        .ranks-box { display: flex; justify-content: space-around; border: 1px solid #000; background: #f9f9f9; padding: 6px; margin-bottom: 8px; font-weight: bold; font-size: 12px; }
...
<body>
<button onclick="window.print()" class="btn-print">🖨️ چاپ گروهی (Layout: <?php echo tr_num($layout, 'fa'); ?> کارنامه در صفحه)</button>
    ...
    <div class="report-card">
        <div>
            ...
            <div class="ranks-box">
                ...
                <div>رتبه کلاس: <span>#<?php echo tr_num($classRank, 'fa'); ?></span></div>
                <div>رتبه پایه: <span>#<?php echo tr_num($gradeRank, 'fa'); ?></span></div>
            </div>
            ...
            <table>
                ...
                <tfoot>
                    ...
                    <tr style="font-size:10px;">
                        ...
                        <td colspan="2">ارزشیابی انضباطی مدرسه</td>
                    </tr>
                </tfoot>
            </table>
        </div>
                ...
                <div class="sig-box" style="position: relative;">
                    ...
                    <div style="height: 45px; position: relative;">
                        <?php if ($sStamp = get_setting('school_stamp_url')): ?>
                            <img src="<?php echo clean($sStamp); ?>" style="max-height: 50px; position: absolute; left: 20px; top: -5px; opacity: 0.8;">
                        <?php endif; ?>
                        <?php if ($pSig = get_setting('principal_signature_url')): ?>
                            <img src="<?php echo clean($pSig); ?>" style="max-height: 45px; position: absolute; left: 40px; top: 0; z-index: 10;">
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <div class="card max-w-xl mx-auto shadow-lg p-6">
        <form method="GET" action="bulk-print.php" target="_blank">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="month" class="form-input font-bold" value="آبان">
            </div>
            <div class="mb-4">
