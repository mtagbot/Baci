...
<div class="max-w-4xl mx-auto space-y-4">
    <div class="card"><h2 class="font-bold">👁️ پیش‌نمایش آزمون: <?php echo clean($exam['title']); ?></h2><p class="text-xs text-muted">این نمای دانش‌آموز است - پاسخ‌ها ذخیره نمی‌شود</p></div>
