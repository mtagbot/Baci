            ...
            <?php foreach ($matrixDays as $day): ?>
                ...
                <tr>
                    ...
                    <td class="ws-cell wsc-<?php echo $ci % 8; ?>" id="<?php echo $cellId; ?>s"
                        ...
                        data-s1="<?php echo clean($s1); ?>" data-s2="<?php echo clean($s2); ?>">
                ...
                <tr class="<?php echo $isLastPeriod ? 'ws-day-sep' : ''; ?>">
                    ...
                    <?php
                        ...
                        $t1n = $t1 && isset($teacherNamesById[$t1]) ? $teacherNamesById[$t1] : '';
                        $t2n = $t2 && isset($teacherNamesById[$t2]) ? $teacherNamesById[$t2] : '';
                    ?>
                    <td class="ws-cell wsc-<?php echo $ci % 8; ?>" id="<?php echo $cellId; ?>t" data-pair="<?php echo $cellId; ?>s"
                        ...
                        <div class="ws-val ws-teach <?php echo $t1 ? '' : 'empty'; ?>" tabindex="0" role="button" data-kind="teach" data-slot="1"><?php echo $t1 ? clean($t1n) : '— دبیر —'; ?></div>
                        <div class="ws-h2" style="<?php echo $r2 ? '' : 'display:none'; ?>">
                            <div class="ws-val ws-teach2 <?php echo $t2 ? '' : 'empty'; ?>" tabindex="0" role="button" data-kind="teach" data-slot="2"><?php echo $t2 ? clean($t2n) : '— دبیر درس دوم —'; ?></div>
                        </div>
                    </td>
                    <?php endforeach; ?>
                </tr>
