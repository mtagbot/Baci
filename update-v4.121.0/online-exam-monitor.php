    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="space-y-4">
            <div class="card" style="border:1.5px solid #ddd6fe;background:linear-gradient(135deg,#faf5ff,#f5f3ff)">
                ...
                <div class="text-[11px] text-muted mb-2">دکمه را نگه دارید و صحبت کنید؛ با رها کردن، صدا ارسال و در دستگاه دانش‌آموز(ان) پخش می‌شود. حداکثر ۶۰ ثانیه.</div>
                <div class="mb-2">
...
async function pttStart(e){
    ...
    try{
        ...
        pttStatus.textContent='❌ دسترسی میکروفون رد شد: '+err.message;
        return;
    }
    pttChunks=[];
    let mime='audio/webm';
