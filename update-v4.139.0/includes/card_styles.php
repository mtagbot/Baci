...
/* ── ستون اطلاعات (چپ) ──────────────────────────────────────── */
.card-info{position:absolute;top:1.4mm;left:2.6mm;width:37mm}
...
/* عکس کوچک، زیر اطلاعات */
.card-photo{
  position:absolute; bottom:5.5mm; left:2.6mm;
...
.card-hero{
  position:absolute; bottom:5mm; left:14.5mm;
...
.card-id.sq{width:54mm;height:54mm}
.card-id.sq .card-head{
  height:6.4mm;padding:.7mm 2mm 0 2mm;
}
.card-id.sq .card-school{font-size:2.4mm;line-height:1.1}
.card-id.sq .card-meta{display:none}          /* جا نیست؛ QR مهم‌تر است */
.card-id.sq .card-head-orn{width:9mm;height:9mm;top:-2mm;left:-2mm}
.card-id.sq .card-logo{width:4.6mm;height:4.6mm;top:.9mm;left:1.6mm}
.card-id.sq .card-body{top:6.4mm;padding:0}
.card-id.sq .card-qr-box{
  top:0.9mm;right:50%;margin-right:-24mm;width:48mm;
}
.card-id.sq .card-qr{width:48mm;height:48mm}
.card-id.sq .card-qr-cap{display:none}
.card-id.sq .card-info{
  position:absolute;top:auto;bottom:0.4mm;right:2mm;left:2mm;width:auto;text-align:center;
}
.card-id.sq .card-name{font-size:2.7mm;line-height:1.15}
.card-id.sq .card-rows{margin-top:0}
.card-id.sq .card-row{font-size:2mm;line-height:1.2;display:inline;margin-left:1.6mm}
.card-id.sq .card-row .lb{display:none}       /* «کلاس:» حذف، خودِ مقدار کافی است */
.card-id.sq .card-photo,
.card-id.sq .card-photo-ph,
.card-id.sq .card-hero,
.card-id.sq .card-foot,
.card-id.sq .card-band,
.card-id.sq .card-bg{display:none}

/* ── ب) کارت مستطیلی، حداکثر QR ممکن ──────────────────────────── */
.card-id.qrmax .card-head{height:6.4mm;padding:.7mm 2mm 0 2mm}
.card-id.qrmax .card-school{font-size:2.5mm;line-height:1.1}
.card-id.qrmax .card-meta{font-size:1.7mm}
.card-id.qrmax .card-head-orn{width:9mm;height:9mm;top:-2mm;left:-2mm}
.card-id.qrmax .card-logo{width:4.8mm;height:4.8mm;top:.8mm;left:1.6mm}
.card-id.qrmax .card-body{top:6.4mm;padding:0}
.card-id.qrmax .card-qr-box{top:0.8mm;right:1.6mm;width:50mm}
.card-id.qrmax .card-qr{width:50mm;height:50mm}
.card-id.qrmax .card-qr-cap{display:none}
.card-id.qrmax .card-info{top:1.6mm;left:1.8mm;width:31mm}
.card-id.qrmax .card-name{font-size:3.4mm}
.card-id.qrmax .card-row{font-size:2.3mm;line-height:1.4}
.card-id.qrmax .card-photo,
.card-id.qrmax .card-photo-ph{bottom:2mm;left:1.8mm;width:10mm;height:13mm}
.card-id.qrmax .card-hero{bottom:2mm;left:13mm;width:19mm;height:13mm}
