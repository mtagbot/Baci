...
<div class="space-y-6">
    ...
    <div class="card no-print">
        ...
        <?php
        $D = ['photo' => true, 'nid' => true, 'year' => true, 'theme' => 'classic', 'cut' => true, 'layout' => 'full'];
...
function resetCardDesign(){
  setCardDesign({layout:'full',theme:'classic',gap:4,margin:8,side:'front',photo:true,nid:true,year:true,cut:true});
  applyCardDesign();
}
