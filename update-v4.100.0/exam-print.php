...
function pageStyleAttr(){/* v4.91.0/v4.100.0: عکس/مهر/کادر/عرض/ارتفاع/فاصله سوال ثابت‌اند — مقادیر ذخیره‌شده قدیمی نادیده گرفته می‌شود */ return Object.entries(pageStyle).filter(([k])=>k!=='--photo'&&k!=='--stamp'&&k!=='--qH'&&k!=='--qW'&&k!=='--qTop'&&k!=='--qBorder').map(([k,v])=>`${k}:${v}`).join(';');}
