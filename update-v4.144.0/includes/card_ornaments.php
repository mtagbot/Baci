...
if (!function_exists('card_ornament_defs')) {
    ...
    function card_ornament_defs($primary, $accent) {
        ...
        ?>
<svg class="tile-sprite" width="0" height="0" viewBox="0 0 0 0" style="position:absolute;width:0;height:0;overflow:hidden;visibility:hidden;pointer-events:none;left:-9999px;top:-9999px" aria-hidden="true" focusable="false"
