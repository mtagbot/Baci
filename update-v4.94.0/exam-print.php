...
function fixHeaderFieldOrder(list){if(!Array.isArray(list))return list; const si=list.findIndex(f=>f&&f.key==='seat'), ti=list.findIndex(f=>f&&f.key==='teacher'); if(si>-1&&ti>-1&&si<ti){const t=list[si]; list[si]=list[ti]; list[ti]=t;} return list;}
