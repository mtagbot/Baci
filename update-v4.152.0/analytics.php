...
<div class="space-y-6">
    ...
    <!-- Top Students Table -->
    <div class="card">
        <h4 class="font-bold mb-4 text-green-700"><svg data-ui-icon="award" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="8" r="6"/><path d="m8 13-2 9 6-3 6 3-2-9"/></svg> نفرات برتر تحصیلی در سال <?php echo clean($selectedYear); ?></h4>
