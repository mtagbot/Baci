...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  <Style ss:ID="Default" ss:Name="Normal">
   ...
   <Font ss:FontName="<?php echo clean(app_export_font_family()); ?>" ss:Size="11"/>
  </Style>
  <Style ss:ID="Header">
   <Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:ReadingOrder="RightToLeft"/>
   <Font ss:FontName="<?php echo clean(app_export_font_family()); ?>" ss:Size="14" ss:Bold="1"/>
  </Style>
  <Style ss:ID="ColHeader">
   <Alignment ss:Horizontal="Center" ss:Vertical="Center" ss:ReadingOrder="RightToLeft"/>
   <Font ss:FontName="<?php echo clean(app_export_font_family()); ?>" ss:Size="11" ss:Bold="1"/>
