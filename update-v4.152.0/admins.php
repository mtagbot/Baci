...
<div class="max-w-2xl mx-auto card p-6">
    ...
    <form method="POST" action="admins.php?id=<?php echo $adminId; ?>">
        ...
        <div class="flex justify-between items-center">
            ...
            <button type="submit" class="btn btn-success px-8 py-2.5 font-bold"><svg data-ui-icon="save" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M3 3h15l3 3v15H3Zm4 0v7h10V3M7 21v-7h10v7"/></svg> ذخیره اطلاعات مدیر</button>
        </div>
    </form>
</div>
<?php
