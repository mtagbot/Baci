...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <a href="settings.php" class="btn btn-outline text-xs gap-1">
            <span><svg data-ui-icon="settings" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M4 6h16M4 12h16M4 18h16M8 3v6m8 0v6m-8 0v6"/></svg> تنظیمات وب‌سرویس پیامک (API Key)</span>
        </a>
    </div>
        ...
        <div class="card col-span-1">
            ...
            <form method="POST">
                ...
                <div class="p-3 bg-slate-50 dark:bg-slate-800 rounded-lg border text-[11px] mb-6 space-y-2">
                    <span class="font-bold text-primary block"><svg data-ui-icon="card" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><rect x="2" y="4" width="20" height="16" rx="2"/><circle cx="8" cy="10" r="2"/><path d="M5 17c0-5 6-5 6 0M14 9h5m-5 5h5"/></svg> شورت‌کدهای هوشمند (برای درج در پیام کلیک کنید):</span>
                ...
                <button type="submit" class="btn btn-primary w-full py-2.5"><svg data-ui-icon="mail" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m3 6 9 7 9-7"/></svg> ارسال پیامک &larr;</button>
            </form>
        </div>
