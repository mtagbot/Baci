...
<div class="space-y-6">
    ...
    <form method="POST" action="import-schedule.php?step=2">
        ...
        <div class="card mb-4 flex justify-between items-center bg-blue-50 dark:bg-slate-800 p-4 border-2 border-indigo-100">
            <div>
                <label class="text-xs font-bold mr-2"><svg data-ui-icon="calendar" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M7 3v4m10-4v4M3 11h18M8 15h2m4 0h2m-8 3h2"/></svg> سال تحصیلی برنامه هفتگی (انتخابی - فرمت جامع):</label>
            ...
            <button type="submit" class="btn btn-success px-6 py-3 font-bold shadow"><svg data-ui-icon="check" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="9"/><path d="m7 12 3 3 7-7"/></svg> تایید نهایی و ثبت برنامه در پایگاه داده &larr;</button>
        </div>
        <div class="card">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($sc['teacher_id']): ?>
                                    <span class="badge bg-green-600 text-white text-xs">تطبیق شد: <?php echo clean($sc['matched_name']); ?> <svg data-ui-icon="check" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="9"/><path d="m7 12 3 3 7-7"/></svg></span>
                                <?php else: ?>
