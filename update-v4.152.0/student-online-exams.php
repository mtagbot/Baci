    ...
    <div class="card bg-gradient-to-l from-indigo-600 to-blue-700 text-white p-6">
        ...
        <?php if (!$isInCurrentYear): ?>
            <div class="mt-3 p-3 bg-amber-200 text-amber-900 rounded text-sm font-bold">
                <svg data-ui-icon="warning" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M12 3 2 21h20Z"/><path d="M12 9v5m0 3v.1"/></svg> <?php echo $yearMismatchMessage; ?>
            </div>
        <?php endif; ?>
    </div>
            ...
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    ...
                    <div class="flex flex-wrap gap-3 text-xs mt-2">
                        <span>طراح: <?php echo clean($ex['teacher_name'] ? teacher_family_name($ex['teacher_name']) : 'مدیر'); ?></span>
                        <span>درس: <?php echo clean($ex['subject_name']); ?></span>
                    ...
                    <?php endif; ?>
                    <?php if(!$ex['can_take'] && !$att): ?><div class="mt-2 text-xs text-red-600"><svg data-ui-icon="warning" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M12 3 2 21h20Z"/><path d="M12 9v5m0 3v.1"/></svg> <?php echo clean($ex['cant_reason']); ?></div><?php endif; ?>
                </div>
