    ...
    <div class="grid grid-cols-3 gap-6">
        <div class="card col-span-1">
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn btn-primary w-full py-2.5 font-bold"><svg data-ui-icon="message" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><path d="M3 3h18v14H9l-6 5ZM7 8h10M7 12h7"/></svg> انتشار اطلاعیه &larr;</button>
            </form>
        </div>
