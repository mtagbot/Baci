...
<div class="space-y-6">
    ...
    <section class="card" aria-labelledby="school-list-title">
        ...
        <p class="text-xs text-muted" style="line-height:2;margin-top:16px">
            ...
            جدول حداقل ۳۰ ردیف اسامی دارد. ردیف‌های بیشتر از ۳۰ و کلاس‌های بیشتر از سه کلاس در هر پایه، در همان جدول اضافه می‌شوند؛ نامی حذف و صفحهٔ ادامه‌ای ساخته نمی‌شود.
            فونت هدف اسامی حداقل ۸ پوینت است؛ با اولویت حفظ یک صفحه، فقط در صورت کمبود فضا کوچک‌تر می‌شود. AutoFit جدول فعال و فاصلهٔ خط همهٔ متن‌ها Single است. برای خوانایی بیشترِ فهرست‌های پُرتعداد A3 را انتخاب کنید.
