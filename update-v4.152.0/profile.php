...
<div class="max-w-md mx-auto card p-6">
    ...
    <form method="POST">
        ...
        <button type="submit" class="btn btn-primary w-full py-2.5 font-bold"><svg data-ui-icon="key" class="school-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"><circle cx="8" cy="8" r="5"/><path d="m12 12 9 9m-5-5 3-3m-6 0 3-3"/></svg> تغییر رمز عبور</button>
    </form>
</div>
