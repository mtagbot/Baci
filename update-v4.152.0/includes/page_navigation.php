...
function app_page_error($message,$status=400) {
    ...
    echo '<script defer src="assets/js/school-navigation.js?v=20260917c"></script></head><body style="margin:24px;line-height:2"><h1 style="font-size:20px">امکان نمایش صفحه نیست</h1><p>'.htmlspecialchars((string)$message,ENT_QUOTES,'UTF-8').'</p><a href="index.php">بازگشت به صفحهٔ اصلی</a></body></html>';
    exit;
}
