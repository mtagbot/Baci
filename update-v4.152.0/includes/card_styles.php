...
/* Square card only: enlarge the symbol without removing the four-module quiet zone. */
.card-id.sq .card-head{height:3mm}
.card-id.sq .card-school{font-size:2.2mm}
.card-id.sq .card-body{top:3mm}
.card-id.sq .card-qr-box{top:0;right:50%;margin-right:-25.2mm;width:50.4mm}
.card-id.sq .card-qr{width:50.4mm;height:50.4mm}
.card-back.sq .card-back-in{padding:.8mm}
.card-back.sq .card-back-qr-box{margin-right:-26mm;margin-top:-26mm;width:52mm}
.card-back.sq .card-back-qr{width:52mm;height:52mm}
