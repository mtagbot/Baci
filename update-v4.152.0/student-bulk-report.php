...
?>
<!DOCTYPE html><html lang="fa" dir="rtl"><head><meta name=viewport content="width=device-width, initial-scale=1"><meta charset="UTF-8"><title><?php echo clean($title); ?></title><style>body{font-family:Tahoma,sans-serif;direction:rtl} .header{text-align:center;border:2px solid #000;padding:12px;margin-bottom:16px}.meta{display:flex;justify-content:space-between;font-size:12px}table{width:100%;border-collapse:collapse}th,td{border:1px solid #333;padding:6px;font-size:12px}th{background:#eee}.sign{margin-top:40px;display:flex;justify-content:space-around}</style><?php echo app_appearance_head(); ?><?php if(!in_array($format,['xls','doc'],true)): ?><link rel=stylesheet href=assets/css/school-ui.css?v20260917b><script defer src=assets/js/school-icons.js?v20260917b></script><script defer src=assets/js/school-ui.js?v20260917b></script><?php endif; ?></head><body>
