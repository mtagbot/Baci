...
<div class="space-y-6 max-w-5xl mx-auto">
    <div class="flex justify-between items-center">
        <h2 class="text-xl font-bold"><?php echo $exam?'ویرایش آزمون آنلاین':'ایجاد آزمون آنلاین جدید'; ?> <span class="text-xs text-muted">(تاریخ‌ها شمسی)</span></h2>
        <a href="online-exams.php" class="btn btn-secondary text-xs">بازگشت به لیست</a>
    </div>
    ...
    <form method="POST" class="space-y-6" data-no-ajax="1">
        ...
        <div class="card space-y-4">
            <h3 class="font-bold border-b pb-2">تنظیمات نمایش و تصادفی‌سازی</h3>
        ...
        <div class="card space-y-4 border-2 border-red-100 bg-red-50/30">
            <h3 class="font-bold border-b pb-2 text-red-700">سیستم ضدتقلب - سازگار با ایران</h3>
            <div class="grid grid-cols-3 gap-3 text-sm">
