    ...
    <div class="grid grid-cols-4 gap-4">
                ...
                <div class="border rounded p-3 hover:shadow-sm bg-white">
                    <div class="flex justify-between">
                        ...
                        <div class="flex gap-1">
                            ...
                            <form method="POST" onsubmit="return confirm('حذف؟')" class="inline"><input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>"><input type="hidden" name="bank_id" value="<?php echo $b['id']; ?>"><button name="delete_bank" class="btn btn-danger text-[10px]">حذف</button></form>
                        </div>
                    </div>
        ...
        <div class="space-y-4">
            ...
            <div class="card">
                ...
                <form method="POST" class="flex gap-1 mb-2"><input type="hidden" name="csrf_token" value="<?php echo csrf_token(); ?>"><input name="cat_name" class="form-input text-xs flex-1" placeholder="نام دسته جدید" required><button name="add_category" class="btn btn-success text-xs">افزودن</button></form>
