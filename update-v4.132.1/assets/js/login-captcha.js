 ...
 * آیا این حساب سابقهٔ ورود ناموفق دارد یا نه.
 *
 * تصمیم‌های عمدی:
 ...
 *  - در صورت هر خطا (آفلاین، ۵۰۰، فایل نبود) کپچا *نمایش داده می‌شود*.
 *    fail-safe: بدترین حالت یک سوال جمع اضافه است، نه باز شدن در.
