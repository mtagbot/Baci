            ...
            <div>
                ...
                <div class="tile-picker">
                    ...
                    <label class="tile-opt <?php echo $on ? 'is-on' : 'is-off'; ?>" data-key="<?php echo clean($k); ?>"
                           data-icon="<?php echo clean($tile['i']); ?>" data-title="<?php echo clean($tile['t']); ?>"
                        ...
                        <span class="ti"><?php echo $tile['i']; ?></span>
    ...
    (function () {
        ...
        function render() {
            ...
            order.forEach(function (key) {
                ...
                a.innerHTML = '<span class="hdr-tile-i">' + lab.dataset.icon + '</span>' +
                              '<span class="hdr-tile-t"></span>';
                a.querySelector('.hdr-tile-t').textContent = lab.dataset.title;
