...
-- =====================================================================
-- v4.131.0 / desktop v2.62.0 — ایندکس‌های کارایی
-- ---------------------------------------------------------------------
-- تا اینجا schema دسکتاپ فقط همین یک ایندکس بالا را داشت، در حالی که
-- sql/database.sql (نسخهٔ MySQL) ۱۱۳ تعریف KEY دارد. یعنی روی دسکتاپ
-- کوئری‌هایی مثل «کارنامه‌های این دانش‌آموز» full table scan می‌شدند.
--
-- اندازه‌گیری‌شده روی SQLite با ۱۲۰٬۰۰۰ ردیف و ۳۰۰ کوئری:
--     بدون ایندکس ۵٫۳۶ms  →  با ایندکس ۰٫۱۲ms   (~۴۳ برابر)
--
-- این ۵۸ ایندکس مستقیماً از تعاریف KEY همان فایل MySQL تولید شده‌اند
-- (به‌علاوهٔ چند مسیر داغِ مخصوص دسکتاپ: حضورغیاب و کارنامه).
-- همه IF NOT EXISTS هستند، پس روی دیتابیس موجود هم بی‌خطر اجرا می‌شوند:
-- ensureSchemaCurrent() در includes/db.php بعد از هر ارتقا همین فایل را
-- دوباره اجرا می‌کند و ایندکس‌ها به دیتابیس‌های قدیمی هم می‌رسند.
-- =====================================================================
...
CREATE INDEX IF NOT EXISTS "idx_report_grades_report_id" ON "report_grades" ("report_id");
CREATE INDEX IF NOT EXISTS "idx_class_schedules_class_name" ON "class_schedules" ("class_name");
CREATE INDEX IF NOT EXISTS "idx_class_schedules_teacher_id" ON "class_schedules" ("teacher_id");
CREATE INDEX IF NOT EXISTS "idx_grade_messages_student_id" ON "grade_messages" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_grade_messages_teacher_id" ON "grade_messages" ("teacher_id");
CREATE INDEX IF NOT EXISTS "idx_bale_bot_users_bale_chat_id" ON "bale_bot_users" ("bale_chat_id");
CREATE INDEX IF NOT EXISTS "idx_bale_bot_users_student_id" ON "bale_bot_users" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_telegram_bot_users_telegram_chat_id" ON "telegram_bot_users" ("telegram_chat_id");
CREATE INDEX IF NOT EXISTS "idx_telegram_bot_users_student_id" ON "telegram_bot_users" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_bot_message_logs_platform_chat_id" ON "bot_message_logs" ("platform", "chat_id");
CREATE INDEX IF NOT EXISTS "idx_bot_message_logs_student_id" ON "bot_message_logs" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_discipline_titles_status" ON "discipline_titles" ("status");
CREATE INDEX IF NOT EXISTS "idx_student_discipline_records_student_id" ON "student_discipline_records" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_student_discipline_records_title_id" ON "student_discipline_records" ("title_id");
CREATE INDEX IF NOT EXISTS "idx_counseling_requests_status" ON "counseling_requests" ("status");
CREATE INDEX IF NOT EXISTS "idx_counseling_requests_student_id" ON "counseling_requests" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_bot_admin_sessions_platform_chat_id_is_active" ON "bot_admin_sessions" ("platform", "chat_id", "is_active");
CREATE INDEX IF NOT EXISTS "idx_exam_schedules_academic_year_class_name" ON "exam_schedules" ("academic_year", "class_name");
CREATE INDEX IF NOT EXISTS "idx_exam_schedules_exam_date_jalali" ON "exam_schedules" ("exam_date_jalali");
CREATE INDEX IF NOT EXISTS "idx_exam_assignments_student_id" ON "exam_assignments" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_exam_student_seating_student_id" ON "exam_student_seating" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_exam_question_bank_subject_name" ON "exam_question_bank" ("subject_name");
CREATE INDEX IF NOT EXISTS "idx_exam_question_bank_academic_year_exam_month" ON "exam_question_bank" ("academic_year", "exam_month");
CREATE INDEX IF NOT EXISTS "idx_exam_question_bank_teacher_id" ON "exam_question_bank" ("teacher_id");
CREATE INDEX IF NOT EXISTS "idx_online_question_categories_teacher_id" ON "online_question_categories" ("teacher_id");
CREATE INDEX IF NOT EXISTS "idx_online_exams_teacher_id" ON "online_exams" ("teacher_id");
CREATE INDEX IF NOT EXISTS "idx_online_exams_academic_year_class_name" ON "online_exams" ("academic_year", "class_name");
CREATE INDEX IF NOT EXISTS "idx_online_exams_status_is_active" ON "online_exams" ("status", "is_active");
CREATE INDEX IF NOT EXISTS "idx_online_exams_start_datetime_end_datetime" ON "online_exams" ("start_datetime", "end_datetime");
CREATE INDEX IF NOT EXISTS "idx_online_question_bank_teacher_id" ON "online_question_bank" ("teacher_id");
CREATE INDEX IF NOT EXISTS "idx_online_question_bank_category_id" ON "online_question_bank" ("category_id");
CREATE INDEX IF NOT EXISTS "idx_online_question_bank_question_type" ON "online_question_bank" ("question_type");
CREATE INDEX IF NOT EXISTS "idx_online_questions_exam_id" ON "online_questions" ("exam_id");
CREATE INDEX IF NOT EXISTS "idx_online_questions_bank_question_id" ON "online_questions" ("bank_question_id");
CREATE INDEX IF NOT EXISTS "idx_online_questions_exam_id_order_index" ON "online_questions" ("exam_id", "order_index");
CREATE INDEX IF NOT EXISTS "idx_online_exam_attempts_exam_id_student_id" ON "online_exam_attempts" ("exam_id", "student_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_attempts_status" ON "online_exam_attempts" ("status");
CREATE INDEX IF NOT EXISTS "idx_online_exam_attempts_student_id" ON "online_exam_attempts" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_answers_attempt_id" ON "online_exam_answers" ("attempt_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_proctoring_logs_attempt_id" ON "online_exam_proctoring_logs" ("attempt_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_proctoring_logs_exam_id" ON "online_exam_proctoring_logs" ("exam_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_proctoring_logs_event_type" ON "online_exam_proctoring_logs" ("event_type");
CREATE INDEX IF NOT EXISTS "idx_online_exam_proctoring_logs_student_id" ON "online_exam_proctoring_logs" ("student_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_live_sessions_exam_id" ON "online_exam_live_sessions" ("exam_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_live_sessions_last_heartbeat" ON "online_exam_live_sessions" ("last_heartbeat");
CREATE INDEX IF NOT EXISTS "idx_online_exam_webcam_requests_attempt_id" ON "online_exam_webcam_requests" ("attempt_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_webcam_requests_status" ON "online_exam_webcam_requests" ("status");
CREATE INDEX IF NOT EXISTS "idx_online_exam_webcam_snapshots_attempt_id" ON "online_exam_webcam_snapshots" ("attempt_id");
CREATE INDEX IF NOT EXISTS "idx_online_exam_webcam_snapshots_exam_id" ON "online_exam_webcam_snapshots" ("exam_id");
CREATE INDEX IF NOT EXISTS "idx_student_attendance_date_jalali" ON "student_attendance" ("date_jalali");
CREATE INDEX IF NOT EXISTS "idx_student_attendance_student_id_date_jalali" ON "student_attendance" ("student_id", "date_jalali");
CREATE INDEX IF NOT EXISTS "idx_activity_logs_admin_id" ON "activity_logs" ("admin_id");
CREATE INDEX IF NOT EXISTS "idx_reports_academic_year_class_name" ON "reports" ("academic_year", "class_name");
CREATE INDEX IF NOT EXISTS "idx_reports_student_id_academic_year" ON "reports" ("student_id", "academic_year");
CREATE INDEX IF NOT EXISTS "idx_report_grades_subject_name" ON "report_grades" ("subject_name");

-- v4.132.0 — «کپچای تطبیقی»: سابقهٔ ورود ناموفق به تفکیک حساب.
-- در includes/header_tiles.php هم به‌صورت تنبل ساخته می‌شود تا نصب‌های
-- قدیمی بدون اجرای مهاجرت هم کار کنند؛ اینجا هست تا نصب تازه از همان
-- ابتدا جدول را داشته باشد.
