#!/usr/bin/env python3
"""Same-version incremental group-exam correction, after the staff-workflows fix."""
...
ARCHIVES = (
    ('SITE-FIX-v4.152.0-class-exam-groups.zip', False),
    ('SchoolDeskPro-FIX-v2.83.0-class-exam-groups.zip', True),
)
