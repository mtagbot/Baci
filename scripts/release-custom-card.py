#!/usr/bin/env python3
"""Incremental custom entry-card layout. No version bump or rebuilding previous releases."""
...
ARCHIVES=(('SITE-FIX-v4.152.0-custom-card.zip','site-update-v4.152.0/'),('SchoolDeskPro-FIX-v2.83.0-custom-card.zip','SchoolDeskPro/www/'))
def build():
