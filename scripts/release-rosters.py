...
def build():
    ...
    deliveries.extend([
        ('SITE-FIX-v4.152.0-a4-paper.zip', 'site-update-v4.152.0/', spacing_fix),
        ('SchoolDeskPro-FIX-v2.83.0-a4-paper.zip', 'SchoolDeskPro/www/', spacing_fix),
        ('SITE-FIX-v4.152.0-roster-layouts.zip', 'site-update-v4.152.0/', spacing_fix),
        ('SchoolDeskPro-FIX-v2.83.0-roster-layouts.zip', 'SchoolDeskPro/www/', spacing_fix),
