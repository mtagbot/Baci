...
ARCHIVES=[('SITE-FIX-v4.152.0-fast-ui.zip','site-update-v4.152.0/',False),('SchoolDeskPro-FIX-v2.83.0-fast-ui.zip','SchoolDeskPro/www/',True)]
...
def build():
 ...
 for name,prefix,desktop in ARCHIVES:
  ...
  if desktop:payload['desk-sync-daemon.php']=ROOT/'desktop-app-v2/patch/www-desk-sync-daemon.php'
 ...
 (ROOT/'FAST-UI-SHA256SUMS.txt').write_text(''.join(sums))
