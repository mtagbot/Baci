...
ARCHIVES=[('SITE-FIX-v4.152.0-report-tools.zip','site-update-v4.152.0/',False),('SchoolDeskPro-FIX-v2.83.0-report-tools.zip','SchoolDeskPro/www/',True)]
...
def build():
 ...
 (ROOT/'REPORT-TOOLS-SHA256SUMS.txt').write_text(''.join(sums))
