...
SITE=COMMON+['class-exam-sync-api.php','cron/bot-outbox-worker.php','includes/header.php']
DESKTOP=COMMON+['includes/desk_sync.php','desk-sync-daemon.php','desk-sync.php','includes/header.php']
def stage(desktop=False):
 ...
 for f in DESKTOP if desktop else SITE:
  source={'desk-sync-daemon.php':ROOT/'desktop-app-v2/patch/www-desk-sync-daemon.php',
          'desk-sync.php':ROOT/'desktop-app-v2/patch/www-desk-sync.php',
          'includes/header.php':ROOT/'desktop-app-v2/patch/includes-header.php'}.get(f,ROOT/'update-v4.152.0'/f)
