...
DESKTOP=COMMON+['includes/desk_sync.php','desk-sync-daemon.php','desk-sync.php']
def stage(desktop=False):
 ...
 for f in DESKTOP if desktop else SITE:
  source=ROOT/'desktop-app-v2/patch/www-desk-sync-daemon.php' if f=='desk-sync-daemon.php' else ROOT/'desktop-app-v2/patch/www-desk-sync.php' if f=='desk-sync.php' else ROOT/'update-v4.152.0'/f
