...
SITE_CORRECTIVES = ['svg-responsive','student-workflow','preview-navigation','fast-ui','mobile-hubs','report-tools','settings-health','bot-outbox','recovery-ui','scanner','desk-update']
DESKTOP_CORRECTIVES = ['svg-responsive','student-workflow','preview-navigation','fast-ui','mobile-hubs','report-tools','settings-health','reports-layout','bot-outbox','optimized-sync','event-sync','recovery-ui','scanner','desk-update']
