...
ARCHIVES=[('SITE-FIX-v4.152.0-mobile-hubs.zip','site-update-v4.152.0/',False),('SchoolDeskPro-FIX-v2.83.0-mobile-hubs.zip','SchoolDeskPro/www/',True)]
...
def build():
 ...
 (ROOT/'MOBILE-HUBS-SHA256SUMS.txt').write_text(''.join(sums))
