...
.sheet{
  ...
  min-height:<?php echo round($pg['h'], 1); ?>mm;
...
<div class="sheet">
    <table style="width:<?php echo $tblPc; ?>%">
        <colgroup>
        ...
        <?php for ($r = 0; $r < $rows; $r++):
            ...
            /* ارتفاع این ردیف در قالب؛ صفر یعنی auto */
            $hv = isset($rh[$r + 5]) ? (int)$rh[$r + 5] : 0;
            $hs = $hv
                ? 'height:calc(' . $mm($hv) . 'mm * var(--rh))'
                : 'height:calc(6.1mm * var(--rh))';
        ?>
        <tr>
...
<div class="sheet">
    ...
    <table style="width:<?php echo $tblPc2; ?>%">
        <colgroup>
            <?php foreach ($pc2 as $w): ?><col style="width:<?php echo $w; ?>%"><?php endforeach; ?>
        </colgroup>
        <tr><td class="t" colspan="7">جدول ثبت میزان تدریس</td></tr>
        <tr>
        ...
        <tr><td class="t" colspan="7">دعوت از اولیا</td></tr>
        <tr>
