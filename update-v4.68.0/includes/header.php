    ...
    <div class="flex items-center gap-4">
        ...
        <div class="user-menu-wrap">
            ...
            <div class="user-menu-dropdown">
                ...
                <?php elseif (function_exists('is_teacher_logged_in') && is_teacher_logged_in()): ?><a href="my-sessions.php" class="badge w-full justify-center text-xs" style="background:#d97706;color:#fff;text-decoration:none;cursor:pointer" title="مشاهده نشست‌های فعال در همه دستگاه‌ها"><?php echo clean($_SESSION['teacher_name'] ?? 'دبیر'); ?></a><a href="logout.php" class="btn btn-danger w-full text-xs">خروج</a><?php endif; ?>
            </div>
        </div>
    </div>
</header>
