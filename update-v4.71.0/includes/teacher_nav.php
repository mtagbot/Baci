...
if (!function_exists('render_teacher_nav')) {
    function render_teacher_nav() {
        ...
        $tiles = [
            ...
            ['teacher-panel.php?tab=exams&year=' . urlencode($tnYear), '🖊️', 'طراحی آزمون', $tnSelf === 'teacher-panel.php' && $tnTab === 'exams'],
    ...
    <div class="tp-hero">
        <div>
            ...
            <h2 class="text-2xl font-bold mb-1">استاد <?php echo clean(teacher_family_name($tnTeacher['full_name'])); ?></h2>
