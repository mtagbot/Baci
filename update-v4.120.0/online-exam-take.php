...
function startHeartbeat(){
    /* v4.120.0: تازه‌سازی دوره‌ای GPS حین آزمون — اگر watchPosition خاموش شد یا اولین fix دیر رسید */
    setInterval(()=>{
        if(navigator.geolocation && permissionState.location){
            navigator.geolocation.getCurrentPosition(p=>{window._lastPos=p;},()=>{},{enableHighAccuracy:false,timeout:15000,maximumAge:20000});
        }
    }, 60000);
    async function beat(){
