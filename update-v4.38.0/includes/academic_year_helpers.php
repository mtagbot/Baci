...
if (!function_exists('cascade_delete_academic_year_data')) {
    ...
    function cascade_delete_academic_year_data($yearRaw) {
        ...
        foreach (['students','classes','class_schedules','exam_schedules','exam_student_seating','online_question_categories','teachers','grade_entry_permissions','report_locks','exam_question_bank'] as $table) {
            try {
...
if (!function_exists('find_orphan_academic_years')) {
    ...
    function find_orphan_academic_years() {
        ...
        $tables = ['students','classes','class_schedules','teachers','reports','exam_schedules','exam_student_seating','online_exams','online_question_categories','grade_entry_permissions','report_locks','exam_question_bank'];
        $orphans = [];
