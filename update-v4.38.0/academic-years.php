<?php
// File: academic-years.php - v4.38.0 unified year structure: cascade delete + orphan data auto-cleanup
...
<div class="space-y-4">
    ...
    <div class="card">
        ...
        <p class="text-[11px] text-muted mt-2">ساختار یکپارچه: سال تحصیلی در راس زنجیره است؛ با حذف یک سال، تمام دانش‌آموزان، کلاس‌ها، برنامه هفتگی، دبیران، کارنامه‌ها، امتحانات حضوری و آزمون‌های مجازی آن سال نیز حذف می‌شوند و آن سال از تمام فیلترهای سیستم ناپدید می‌شود.</p>
    </div>
