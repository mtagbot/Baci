            ...
            <table id="studentsTable">
                ...
                <?php foreach ($studentsList as $st): ?>
                    <tr class="student-row" data-student-id="<?php echo (int)$st['id']; ?>">
                        ...
                        <td><div class="flex gap-1 justify-end flex-wrap items-center"><button type="button" onclick="openStudentModal('reports', <?php echo $st['id']; ?>)" class="btn btn-outline text-xs px-2 py-1 text-blue-600">کارنامه‌ها</button><button type="button" onclick="openStudentModal('discipline', <?php echo $st['id']; ?>)" class="btn btn-warning text-xs px-2 py-1">انضباط</button><button type="button" class="btn btn-outline text-xs px-2 py-1 row-menu-btn" onclick="openRowMenu(event, <?php echo $st['id']; ?>)" title="سایر عملیات" aria-label="سایر عملیات">&#8942;</button></div></td>
                    </tr>
