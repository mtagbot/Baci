...
static void tray_add(HINSTANCE hi) {
  ...
  lstrcpyW(g_nid.szTip, L"SchoolDesk");
...
static void tray_menu(void) {
  ...
  AppendMenuW(m, MF_STRING, ID_TRAY_SYNC, L"\x0647\x0645\x06AF\x0627\x0645\x200C\x0633\x0627\x0632\x06CC \x0641\x0648\x0631\x06CC"); /* همگام‌سازی فوری */
...
int webwin_run(const char *url) {
  ...
  g_hwnd = CreateWindowExW(0, L"SchoolDeskWnd",
      L"SchoolDesk \x2014 \x067E\x0646\x0644 \x0645\x062F\x06CC\x0631\x06CC\x062A \x0645\x062F\x0631\x0633\x0647", /* SchoolDesk — پنل مدیریت مدرسه */
