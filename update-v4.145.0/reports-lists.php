        ...
        <div class="flex justify-between items-center flex-wrap gap-2" style="margin-bottom:12px">
            <div>
                ...
                <p class="text-xs text-muted">
                    ...
                    اسامی به ترتیب الفبا و با فونت تیتر درج می‌شوند.
                </p>
            </div>
            <?php if ($templateOk && $zipOk): ?>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php elseif ($templateOk && $zipOk): ?>
                                <a class="btn btn-primary text-xs" href="reports-lists.php?action=class_list_docx&class=<?php echo urlencode($cn); ?>">دانلود Word</a>
                            <?php else: ?>
                                <span class="text-xs text-muted">در دسترس نیست</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
