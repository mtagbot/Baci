...
if ($text === '/start') {
    ...
    if ($staffOnStart) {
        ...
        $tFamS = function_exists('teacher_family_name') ? teacher_family_name($staffOnStart['full_name']) : $staffOnStart['full_name'];
        $roleNames = [];
...
if ($step === 'teacher_password') {
    ...
    if ($teacher && (password_verify($text, $teacher['password']) || hash_equals((string)$teacher['password'], $text) || hash_equals((string)$teacher['personnel_code'], $text))) {
        ...
        $tFam = function_exists('teacher_family_name') ? teacher_family_name($teacher['full_name']) : $teacher['full_name'];
...
if ($step === 'awaiting_nid') {
    ...
    if ($staffMatch) {
        ...
        $tFamD = function_exists('teacher_family_name') ? teacher_family_name($staffMatch['full_name']) : $staffMatch['full_name'];
...
if ($step === 'staff_personnel_code') {
    ...
    if ($okStaff) {
        ...
        $tFamL = function_exists('teacher_family_name') ? teacher_family_name($teacher['full_name']) : $teacher['full_name'];
