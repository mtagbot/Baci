...
check(said(w,'کد ملی باید دقیقاً ۱۰ رقم عددی باشد'),'a random text still gets the national-id error');
...
check(said(w,'کد ملی باید دقیقاً ۱۰ رقم عددی باشد'),'the disabled username gets the normal error');
