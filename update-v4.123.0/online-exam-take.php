            ...
            if(i===strategies.length-1){
                ...
                try {
                    ...
                    if(ipRes && ipRes.latitude && ipRes.longitude){
                        ...
                        detailEl.textContent=`موقعیت تقریبی از IP: ${ipRes.city||''} ${ipRes.region||''} - بدون ماهواره`;
                    } else {
                        /* v4.120.0: مختصات جعلی ممنوع — موقعیت نامشخص = null (دبیر «نامشخص» می‌بیند نه مختصات دروغ) */
...
function continueWithIpFallback(){
    ...
    permissionState.location=true;
    /* v4.120.0: مختصات جعلی تهران حذف شد — سرور از IP موقعیت تقریبی می‌سازد یا نامشخص می‌ماند */
    window._lastPos = null;
