    ...
    <div class="flex items-center gap-4">
        ...
        <div class="user-menu-wrap">
            ...
            <div class="user-menu-dropdown">
                ...
                <?php if (is_admin_logged_in()): ?><div class="badge w-full justify-center text-xs" style="background:var(--primary,#2563eb);color:#fff"><?php echo clean($_SESSION['admin_name'] ?? 'مدیر'); ?></div><a href="index.php?action=logout" class="btn btn-danger w-full text-xs">خروج</a>
                <?php elseif (is_student_logged_in()): ?><div class="badge w-full justify-center text-xs" style="background:#059669;color:#fff"><?php echo clean($_SESSION['student_name'] ?? 'دانش‌آموز'); ?></div><a href="index.php?action=logout" class="btn btn-danger w-full text-xs">خروج</a>
                <?php elseif (function_exists('is_teacher_logged_in') && is_teacher_logged_in()): ?><div class="badge w-full justify-center text-xs" style="background:#d97706;color:#fff"><?php echo clean($_SESSION['teacher_name'] ?? 'دبیر'); ?></div><a href="logout.php" class="btn btn-danger w-full text-xs">خروج</a><?php endif; ?>
            </div>
        </div>
    </div>
</header>
