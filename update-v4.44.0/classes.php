...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_subject'])) {
    if (verify_csrf($_POST['csrf_token'] ?? '')) {
        // v4.40.0 - subject name is a free TEXT input again (per user request); code stays auto
        ...
        <div class="card col-span-1 shadow-lg">
            ...
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" class="form-input font-bold" placeholder="نام درس را وارد کنید" required list="subjNamesData">
                    <datalist id="subjNamesData">
                        <?php foreach ($subjectNameOptions as $sn): ?>
                            <option value="<?php echo clean($sn); ?>"></option>
                        <?php endforeach; ?>
                    </datalist>
                </div>
                <div class="mb-4">
