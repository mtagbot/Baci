...
@media print{
  /* v4.53.0: چاپ کاملاً خالص — فقط QRها، هیچ چیز دیگر */
  ...
  .qr-grid{grid-template-columns:repeat(auto-fill,var(--tagmm));gap:4mm;justify-content:flex-start}
  .qr-item{border:0 !important;padding:0 !important;background:none !important;border-radius:0 !important;box-shadow:none !important}
